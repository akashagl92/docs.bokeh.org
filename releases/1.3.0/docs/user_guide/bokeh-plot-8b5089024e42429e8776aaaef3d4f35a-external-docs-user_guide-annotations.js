(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("baa3cfe9-96ff-4d31-8566-ab15cf57c0d0");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'baa3cfe9-96ff-4d31-8566-ab15cf57c0d0' but no matching script tag was found. ")
        return false;
      }
