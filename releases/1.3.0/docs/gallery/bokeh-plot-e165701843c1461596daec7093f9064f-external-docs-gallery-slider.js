(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("4c7f47b4-f08f-4656-bbe4-164295a293c8");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '4c7f47b4-f08f-4656-bbe4-164295a293c8' but no matching script tag was found. ")
        return false;
      }
