(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("cf6e7a2b-d2d3-4245-9b37-2076b8a93ded");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'cf6e7a2b-d2d3-4245-9b37-2076b8a93ded' but no matching script tag was found. ")
        return false;
      }
