(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("49c61561-a544-432a-b58a-80b162479c3c");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '49c61561-a544-432a-b58a-80b162479c3c' but no matching script tag was found. ")
        return false;
      }
