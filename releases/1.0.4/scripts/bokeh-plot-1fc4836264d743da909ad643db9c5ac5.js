(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("1378b185-82a1-4e91-bf46-488d03b63672");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '1378b185-82a1-4e91-bf46-488d03b63672' but no matching script tag was found. ")
        return false;
      }
