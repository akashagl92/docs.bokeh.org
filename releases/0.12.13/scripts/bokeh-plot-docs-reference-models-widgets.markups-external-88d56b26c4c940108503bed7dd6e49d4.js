(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("8d3f646e-ae22-463f-aad1-29903d5069d1");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '8d3f646e-ae22-463f-aad1-29903d5069d1' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"ac6027ad-6ca0-4ee4-ba3e-d55220ed240a":{"roots":{"references":[{"attributes":{"height":100,"text":"Your text is initialized with the &#x27;text&#x27; argument.\\n\\nThe remaining Paragraph arguments are &#x27;width&#x27; and &#x27;height&#x27;. For this example,\\nthose values are 500 and 100 respectively.","width":500},"id":"be0ee850-d8f9-4875-9288-e473f5b5d021","type":"PreText"},{"attributes":{"children":[{"id":"be0ee850-d8f9-4875-9288-e473f5b5d021","type":"PreText"}]},"id":"1329a706-f2c7-461c-b7e0-581bab166354","type":"WidgetBox"}],"root_ids":["1329a706-f2c7-461c-b7e0-581bab166354"]},"title":"Bokeh Application","version":"0.12.13"}}';
                  var render_items = [{"docid":"ac6027ad-6ca0-4ee4-ba3e-d55220ed240a","elementid":"8d3f646e-ae22-463f-aad1-29903d5069d1","modelid":"1329a706-f2c7-461c-b7e0-581bab166354"}];
