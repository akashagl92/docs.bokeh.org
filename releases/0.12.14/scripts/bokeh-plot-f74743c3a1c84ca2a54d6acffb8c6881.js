(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("f936702d-3663-4676-abc5-d2ec14d65552");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'f936702d-3663-4676-abc5-d2ec14d65552' but no matching script tag was found. ")
        return false;
      }
