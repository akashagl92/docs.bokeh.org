(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("3b175612-d776-45e4-9dcc-c489d09cdab3");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '3b175612-d776-45e4-9dcc-c489d09cdab3' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"ed55886c-ae2a-4702-ae62-ca4e8b3f90ed":{"roots":{"references":[{"attributes":{"children":[{"id":"59901e7f-69e8-406a-a137-e34bded54e08","type":"PreText"}]},"id":"dd9571ea-65c7-475c-88af-96a6e3d1aed9","type":"WidgetBox"},{"attributes":{"height":100,"text":"Your text is initialized with the &#x27;text&#x27; argument.\\n\\nThe remaining Paragraph arguments are &#x27;width&#x27; and &#x27;height&#x27;. For this example,\\nthose values are 500 and 100 respectively.","width":500},"id":"59901e7f-69e8-406a-a137-e34bded54e08","type":"PreText"}],"root_ids":["dd9571ea-65c7-475c-88af-96a6e3d1aed9"]},"title":"Bokeh Application","version":"0.12.14"}}';
                  var render_items = [{"docid":"ed55886c-ae2a-4702-ae62-ca4e8b3f90ed","elementid":"3b175612-d776-45e4-9dcc-c489d09cdab3","modelid":"dd9571ea-65c7-475c-88af-96a6e3d1aed9"}];
