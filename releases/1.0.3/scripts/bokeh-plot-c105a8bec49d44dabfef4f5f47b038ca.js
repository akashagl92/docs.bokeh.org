(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("79cf62e3-0c78-4a9a-a16a-7ba87c3bc1d4");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '79cf62e3-0c78-4a9a-a16a-7ba87c3bc1d4' but no matching script tag was found. ")
        return false;
      }
