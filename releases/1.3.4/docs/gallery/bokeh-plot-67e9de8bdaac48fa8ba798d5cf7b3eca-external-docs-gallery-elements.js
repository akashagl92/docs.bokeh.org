(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("57c222d0-0ddd-477b-bb36-f8560ce95373");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '57c222d0-0ddd-477b-bb36-f8560ce95373' but no matching script tag was found. ")
        return false;
      }
