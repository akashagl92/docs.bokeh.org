(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("726289e1-6376-4238-999b-41e8adcd3bc7");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '726289e1-6376-4238-999b-41e8adcd3bc7' but no matching script tag was found. ")
        return false;
      }
