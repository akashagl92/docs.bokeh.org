(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("39e2e39d-f060-463e-9bf8-ba55bd58122a");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '39e2e39d-f060-463e-9bf8-ba55bd58122a' but no matching script tag was found. ")
        return false;
      }
