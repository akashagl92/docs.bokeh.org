(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("63af5b9e-4cd1-4db1-a1d2-eafe033e1a75");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '63af5b9e-4cd1-4db1-a1d2-eafe033e1a75' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"5eee683a-4d48-4673-a291-a3e6d3dc7b7d":{"roots":{"references":[{"attributes":{"children":[{"id":"0304e2d3-8614-42f6-a5c3-be61ec17853b","type":"PreText"}]},"id":"8f5818d0-b850-4bbf-8d8a-7c98cfe422f9","type":"WidgetBox"},{"attributes":{"height":100,"text":"Your text is initialized with the &#x27;text&#x27; argument.\\n\\nThe remaining Paragraph arguments are &#x27;width&#x27; and &#x27;height&#x27;. For this example,\\nthose values are 500 and 100 respectively.","width":500},"id":"0304e2d3-8614-42f6-a5c3-be61ec17853b","type":"PreText"}],"root_ids":["8f5818d0-b850-4bbf-8d8a-7c98cfe422f9"]},"title":"Bokeh Application","version":"0.12.12"}}';
                  var render_items = [{"docid":"5eee683a-4d48-4673-a291-a3e6d3dc7b7d","elementid":"63af5b9e-4cd1-4db1-a1d2-eafe033e1a75","modelid":"8f5818d0-b850-4bbf-8d8a-7c98cfe422f9"}];
