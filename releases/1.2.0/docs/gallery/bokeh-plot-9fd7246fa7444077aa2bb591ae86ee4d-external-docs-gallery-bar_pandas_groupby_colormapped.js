(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("087f9f34-f6e7-4e85-b158-86878bec16e9");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '087f9f34-f6e7-4e85-b158-86878bec16e9' but no matching script tag was found. ")
        return false;
      }
