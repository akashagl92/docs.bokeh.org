(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("727a5e8a-bb10-48bd-b99e-7714a980fffb");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '727a5e8a-bb10-48bd-b99e-7714a980fffb' but no matching script tag was found. ")
        return false;
      }
