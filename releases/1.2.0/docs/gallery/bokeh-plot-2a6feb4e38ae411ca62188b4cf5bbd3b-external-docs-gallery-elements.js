(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("affd43ef-eaeb-49cf-bd3a-889a4a622a80");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'affd43ef-eaeb-49cf-bd3a-889a4a622a80' but no matching script tag was found. ")
        return false;
      }
