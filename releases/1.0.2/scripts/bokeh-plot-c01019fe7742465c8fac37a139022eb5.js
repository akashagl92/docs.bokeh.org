(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("7287713c-5091-4521-8f50-4057f7efee8a");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '7287713c-5091-4521-8f50-4057f7efee8a' but no matching script tag was found. ")
        return false;
      }
