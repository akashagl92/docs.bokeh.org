(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("eae9eec1-6ff0-4e43-a2bc-7e2f93cfd2b1");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'eae9eec1-6ff0-4e43-a2bc-7e2f93cfd2b1' but no matching script tag was found. ")
        return false;
      }
