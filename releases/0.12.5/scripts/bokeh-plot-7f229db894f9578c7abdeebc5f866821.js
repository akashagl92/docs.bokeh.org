(function() {
  var fn = function() {
    ...
    (function(global) {
      ...
      };var element = document.getElementById("a343dcbe-c928-4906-9164-3b2bf1c50433");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'a343dcbe-c928-4906-9164-3b2bf1c50433' but no matching script tag was found. ")
        return false;
      }
