(function() {
  var fn = function() {
    ...
    (function(global) {
      ...
      };var element = document.getElementById("b1014ff5-0bcb-4ab7-bfb9-a9f825381015");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'b1014ff5-0bcb-4ab7-bfb9-a9f825381015' but no matching script tag was found. ")
        return false;
      }
