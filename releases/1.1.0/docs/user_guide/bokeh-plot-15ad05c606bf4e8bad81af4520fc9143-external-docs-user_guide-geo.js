(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("2f7081c8-e438-44ad-ac68-e5c48bbd3e60");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '2f7081c8-e438-44ad-ac68-e5c48bbd3e60' but no matching script tag was found. ")
        return false;
      }
