(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("4a87cf2a-de1a-4815-ba62-a5ea8628d364");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '4a87cf2a-de1a-4815-ba62-a5ea8628d364' but no matching script tag was found. ")
        return false;
      }
