(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("6a9a7252-592a-492a-8ebb-2c9e8701b013");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '6a9a7252-592a-492a-8ebb-2c9e8701b013' but no matching script tag was found. ")
        return false;
      }
