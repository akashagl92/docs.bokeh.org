(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("4ecf9aa2-635f-42f2-a1c3-2a46961d8051");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '4ecf9aa2-635f-42f2-a1c3-2a46961d8051' but no matching script tag was found. ")
        return false;
      }
