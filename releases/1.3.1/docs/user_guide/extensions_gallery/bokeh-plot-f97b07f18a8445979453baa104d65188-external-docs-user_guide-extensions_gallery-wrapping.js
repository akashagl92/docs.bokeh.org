(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("954e67da-3694-4d34-94b9-1ac5f95884c7");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '954e67da-3694-4d34-94b9-1ac5f95884c7' but no matching script tag was found. ")
        return false;
      }
        ...
        function(Bokeh) {
          ...
          ({
            "custom/main": function(require, module, exports) {
              var models = {
                "Surface3d": require("custom/bk_script_23328.surface3d").Surface3d
              };
              require("base").register_models(models);
              module.exports = models;
            },
            "custom/bk_script_23328.surface3d": function(require, module, exports) {
          "use strict";
