document.addEventListener("DOMContentLoaded", function(event) {
    ...
    (function(global) {
      ...
      };var element = document.getElementById("a8ca63f5-63a1-4628-a03d-1121bd8b8d06");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'a8ca63f5-63a1-4628-a03d-1121bd8b8d06' but no matching script tag was found. ")
        return false;
      }
        ...
        function(Bokeh) {
          Bokeh.$(function() {
              Bokeh.safely(function() {
                  var docs_json = {"ab4d48a9-bdfd-4e49-8e3d-e2fcf5a66952":{"roots":{"references":[{"attributes":{"children":[{"id":"2b7bce6f-0e55-4ae3-8f81-0631364275a3","type":"MultiSelect"}]},"id":"fd444910-4baa-4668-be8f-8251135eb75b","type":"WidgetBox"},{"attributes":{"callback":null,"options":[["foo","Foo"],["bar","BAR"],["baz","bAz"],["quux","quux"]],"title":"Option:","value":["foo","quux"]},"id":"2b7bce6f-0e55-4ae3-8f81-0631364275a3","type":"MultiSelect"}],"root_ids":["fd444910-4baa-4668-be8f-8251135eb75b"]},"title":"Bokeh Application","version":"0.12.3.10133"}};
                  var render_items = [{"docid":"ab4d48a9-bdfd-4e49-8e3d-e2fcf5a66952","elementid":"a8ca63f5-63a1-4628-a03d-1121bd8b8d06","modelid":"fd444910-4baa-4668-be8f-8251135eb75b"}];
