(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("2528b91f-b2fe-4b4c-8189-26904f0afde4");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '2528b91f-b2fe-4b4c-8189-26904f0afde4' but no matching script tag was found. ")
        return false;
      }
