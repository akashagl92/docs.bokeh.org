(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("05f5d361-defd-4983-be0c-ebb1be9ce854");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '05f5d361-defd-4983-be0c-ebb1be9ce854' but no matching script tag was found. ")
        return false;
      }
