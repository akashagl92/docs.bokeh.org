(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("9dcc20b9-c594-404a-aeca-26895cd4a717");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '9dcc20b9-c594-404a-aeca-26895cd4a717' but no matching script tag was found. ")
        return false;
      }
