(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("df6af152-4f5c-466a-86ed-3b7f9a87ec73");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'df6af152-4f5c-466a-86ed-3b7f9a87ec73' but no matching script tag was found. ")
        return false;
      }
