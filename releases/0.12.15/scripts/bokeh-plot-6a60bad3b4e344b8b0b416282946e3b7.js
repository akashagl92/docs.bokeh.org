(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("5e68a2b7-c2a8-416d-8f61-ae308b6e2125");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '5e68a2b7-c2a8-416d-8f61-ae308b6e2125' but no matching script tag was found. ")
        return false;
      }
