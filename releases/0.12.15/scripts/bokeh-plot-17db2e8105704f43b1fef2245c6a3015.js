(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("6061f7fc-f24c-4c7e-860d-98a1eca7eae2");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '6061f7fc-f24c-4c7e-860d-98a1eca7eae2' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"2b3b5885-787d-45f3-94e1-0ea0811d1eb0":{"roots":{"references":[{"attributes":{"children":[{"id":"59208556-5fdd-474f-9301-3bba0bc0a2e1","type":"RadioGroup"}]},"id":"93a9b6e5-c465-4095-a5b3-3d7295ab9368","type":"WidgetBox"},{"attributes":{"active":0,"callback":null,"labels":["Option 1","Option 2","Option 3"]},"id":"59208556-5fdd-474f-9301-3bba0bc0a2e1","type":"RadioGroup"}],"root_ids":["93a9b6e5-c465-4095-a5b3-3d7295ab9368"]},"title":"Bokeh Application","version":"0.12.15"}}';
                  var render_items = [{"docid":"2b3b5885-787d-45f3-94e1-0ea0811d1eb0","elementid":"6061f7fc-f24c-4c7e-860d-98a1eca7eae2","modelid":"93a9b6e5-c465-4095-a5b3-3d7295ab9368"}];
