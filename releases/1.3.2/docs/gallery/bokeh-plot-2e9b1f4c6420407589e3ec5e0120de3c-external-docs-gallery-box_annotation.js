(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("4cc3d0f2-fb19-4992-9929-5b007823f2ad");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '4cc3d0f2-fb19-4992-9929-5b007823f2ad' but no matching script tag was found. ")
        return false;
      }
