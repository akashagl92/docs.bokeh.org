(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("af3cf26e-a586-4609-87c7-018c02b4b01d");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'af3cf26e-a586-4609-87c7-018c02b4b01d' but no matching script tag was found. ")
        return false;
      }
