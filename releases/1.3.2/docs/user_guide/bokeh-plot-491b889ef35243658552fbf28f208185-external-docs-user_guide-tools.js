(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("24f21aa2-d780-4e82-bb76-f45f70c19a0f");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '24f21aa2-d780-4e82-bb76-f45f70c19a0f' but no matching script tag was found. ")
        return false;
      }
