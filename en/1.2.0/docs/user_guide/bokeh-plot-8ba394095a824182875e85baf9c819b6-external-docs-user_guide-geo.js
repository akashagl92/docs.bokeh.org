(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("6642fffa-8f25-4887-bde1-7a0422d3be28");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '6642fffa-8f25-4887-bde1-7a0422d3be28' but no matching script tag was found. ")
        return false;
      }
