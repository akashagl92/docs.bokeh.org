(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("b3e95895-c457-4dc7-8501-72e6911ebfb3");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'b3e95895-c457-4dc7-8501-72e6911ebfb3' but no matching script tag was found. ")
        return false;
      }
        ...
        function(Bokeh) {
          ...
          ({
            "custom/main": function(require, module, exports) {
              var models = {
                "Surface3d": require("custom/bk_script_23307.surface3d").Surface3d
              };
              require("base").register_models(models);
              module.exports = models;
            },
            "custom/bk_script_23307.surface3d": function(require, module, exports) {
          "use strict";
