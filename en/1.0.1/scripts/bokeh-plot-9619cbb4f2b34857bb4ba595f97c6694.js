(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("bf3d8188-4851-4d88-9efb-4da436e3562d");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'bf3d8188-4851-4d88-9efb-4da436e3562d' but no matching script tag was found. ")
        return false;
      }
