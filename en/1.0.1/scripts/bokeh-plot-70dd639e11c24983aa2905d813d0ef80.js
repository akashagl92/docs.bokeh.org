(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("37d42f42-30a9-4f49-b829-515f793e6943");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '37d42f42-30a9-4f49-b829-515f793e6943' but no matching script tag was found. ")
        return false;
      }
