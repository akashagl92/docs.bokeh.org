(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("6ca7ec31-da24-4211-8bc7-463d412a4e3c");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '6ca7ec31-da24-4211-8bc7-463d412a4e3c' but no matching script tag was found. ")
        return false;
      }
