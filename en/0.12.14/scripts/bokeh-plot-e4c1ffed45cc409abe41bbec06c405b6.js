(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("9341104b-d40d-4e52-98b4-9886d92c54ef");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '9341104b-d40d-4e52-98b4-9886d92c54ef' but no matching script tag was found. ")
        return false;
      }
