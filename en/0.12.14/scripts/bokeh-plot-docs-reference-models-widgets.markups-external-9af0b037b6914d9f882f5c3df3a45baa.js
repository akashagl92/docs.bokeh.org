(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("452f2d13-d92d-4a5f-af60-ba8ed881bd94");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '452f2d13-d92d-4a5f-af60-ba8ed881bd94' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"d54897d8-19ac-4081-9898-f886cf79554c":{"roots":{"references":[{"attributes":{"children":[{"id":"3c373c69-651a-4dce-953b-e048b755c17c","type":"PreText"}]},"id":"5ba5002b-6f6a-4bf2-a09d-930d4f222cdb","type":"WidgetBox"},{"attributes":{"height":100,"text":"Your text is initialized with the &#x27;text&#x27; argument.\\n\\nThe remaining Paragraph arguments are &#x27;width&#x27; and &#x27;height&#x27;. For this example,\\nthose values are 500 and 100 respectively.","width":500},"id":"3c373c69-651a-4dce-953b-e048b755c17c","type":"PreText"}],"root_ids":["5ba5002b-6f6a-4bf2-a09d-930d4f222cdb"]},"title":"Bokeh Application","version":"0.12.14"}}';
                  var render_items = [{"docid":"d54897d8-19ac-4081-9898-f886cf79554c","elementid":"452f2d13-d92d-4a5f-af60-ba8ed881bd94","modelid":"5ba5002b-6f6a-4bf2-a09d-930d4f222cdb"}];
