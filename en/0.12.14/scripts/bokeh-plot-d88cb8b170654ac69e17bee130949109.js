(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("7b9f78fe-4327-4906-8c23-59cb343ee008");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '7b9f78fe-4327-4906-8c23-59cb343ee008' but no matching script tag was found. ")
        return false;
      }
