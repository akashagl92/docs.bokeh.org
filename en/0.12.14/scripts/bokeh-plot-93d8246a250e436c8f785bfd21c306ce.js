(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("e24367f2-37e1-4646-b4aa-bf7c7834d914");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'e24367f2-37e1-4646-b4aa-bf7c7834d914' but no matching script tag was found. ")
        return false;
      }
