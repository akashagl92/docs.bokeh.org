(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("1af5dcb6-9566-421b-90d5-f48c7fe27cf1");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '1af5dcb6-9566-421b-90d5-f48c7fe27cf1' but no matching script tag was found. ")
        return false;
      }
