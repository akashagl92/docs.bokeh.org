(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("b4811d6a-68e6-48df-a283-21fcc2029a0b");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'b4811d6a-68e6-48df-a283-21fcc2029a0b' but no matching script tag was found. ")
        return false;
      }
