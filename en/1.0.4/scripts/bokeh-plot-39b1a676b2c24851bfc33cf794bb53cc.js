(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("5237a168-39d7-4498-91ac-2a7f7fabbd72");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '5237a168-39d7-4498-91ac-2a7f7fabbd72' but no matching script tag was found. ")
        return false;
      }
