(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("dc3832d4-c171-4a4d-a57b-8f0fc274cca5");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'dc3832d4-c171-4a4d-a57b-8f0fc274cca5' but no matching script tag was found. ")
        return false;
      }
