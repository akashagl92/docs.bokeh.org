(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("fd304a74-05bf-4c06-b461-0504a241d780");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'fd304a74-05bf-4c06-b461-0504a241d780' but no matching script tag was found. ")
        return false;
      }
