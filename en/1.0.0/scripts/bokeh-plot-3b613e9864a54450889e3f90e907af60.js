(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("9e3a35c3-d216-4c48-bc8d-0afff0dcd1e8");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '9e3a35c3-d216-4c48-bc8d-0afff0dcd1e8' but no matching script tag was found. ")
        return false;
      }
