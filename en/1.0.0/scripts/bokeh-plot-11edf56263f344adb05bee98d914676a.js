(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("8d524bf7-bdc5-4002-bf1d-f4be0f82fed9");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '8d524bf7-bdc5-4002-bf1d-f4be0f82fed9' but no matching script tag was found. ")
        return false;
      }
