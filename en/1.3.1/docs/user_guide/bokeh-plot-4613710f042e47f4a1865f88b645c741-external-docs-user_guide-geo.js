(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("e6f647cb-b9af-4a99-9de2-d1f911bf8f9e");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'e6f647cb-b9af-4a99-9de2-d1f911bf8f9e' but no matching script tag was found. ")
        return false;
      }
