(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("7c2fc3d0-8759-4c48-834e-7cc780a976ec");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '7c2fc3d0-8759-4c48-834e-7cc780a976ec' but no matching script tag was found. ")
        return false;
      }
