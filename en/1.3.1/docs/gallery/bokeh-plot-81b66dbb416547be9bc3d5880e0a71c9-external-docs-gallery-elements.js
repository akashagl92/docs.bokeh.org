(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("0c54a6e9-ee6a-43c1-aa15-91e7176d49e3");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '0c54a6e9-ee6a-43c1-aa15-91e7176d49e3' but no matching script tag was found. ")
        return false;
      }
