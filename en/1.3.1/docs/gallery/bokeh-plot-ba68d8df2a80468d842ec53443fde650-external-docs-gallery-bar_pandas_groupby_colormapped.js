(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("802beafa-321a-435e-99f5-18f5b08304a0");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '802beafa-321a-435e-99f5-18f5b08304a0' but no matching script tag was found. ")
        return false;
      }
