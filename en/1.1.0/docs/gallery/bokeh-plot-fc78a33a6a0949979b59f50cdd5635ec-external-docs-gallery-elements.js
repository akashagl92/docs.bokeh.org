(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("40063510-f0ce-4636-82e4-7f2608103007");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '40063510-f0ce-4636-82e4-7f2608103007' but no matching script tag was found. ")
        return false;
      }
