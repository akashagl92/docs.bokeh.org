(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("a3787c68-07b5-4d15-8651-c9f61dd502d2");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'a3787c68-07b5-4d15-8651-c9f61dd502d2' but no matching script tag was found. ")
        return false;
      }
