(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("47022ba7-e636-4c64-b1dc-1eba8cff2f8c");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '47022ba7-e636-4c64-b1dc-1eba8cff2f8c' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"25696b88-b4b8-4224-addd-56b54ab1aa7a":{"roots":{"references":[{"attributes":{"children":[{"id":"ebc1819b-a0a2-4655-891d-0bd5eb251a52","type":"PreText"}]},"id":"ea3acbe7-5a49-41a7-96a1-d3e308f2e668","type":"WidgetBox"},{"attributes":{"height":100,"text":"Your text is initialized with the &#x27;text&#x27; argument.\\n\\nThe remaining Paragraph arguments are &#x27;width&#x27; and &#x27;height&#x27;. For this example,\\nthose values are 500 and 100 respectively.","width":500},"id":"ebc1819b-a0a2-4655-891d-0bd5eb251a52","type":"PreText"}],"root_ids":["ea3acbe7-5a49-41a7-96a1-d3e308f2e668"]},"title":"Bokeh Application","version":"0.12.12"}}';
                  var render_items = [{"docid":"25696b88-b4b8-4224-addd-56b54ab1aa7a","elementid":"47022ba7-e636-4c64-b1dc-1eba8cff2f8c","modelid":"ea3acbe7-5a49-41a7-96a1-d3e308f2e668"}];
