(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("7003c094-ba78-48a0-8277-dc01994cf15d");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '7003c094-ba78-48a0-8277-dc01994cf15d' but no matching script tag was found. ")
        return false;
      }
