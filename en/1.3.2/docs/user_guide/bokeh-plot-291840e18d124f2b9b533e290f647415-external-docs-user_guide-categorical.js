(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("00b06a41-3866-4f3c-bbed-85a8a76bf350");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '00b06a41-3866-4f3c-bbed-85a8a76bf350' but no matching script tag was found. ")
        return false;
      }
