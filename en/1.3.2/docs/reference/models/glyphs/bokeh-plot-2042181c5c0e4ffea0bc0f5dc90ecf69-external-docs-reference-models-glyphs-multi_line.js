(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("e0be6cd0-125a-4691-abcb-c7f98d64cbe0");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'e0be6cd0-125a-4691-abcb-c7f98d64cbe0' but no matching script tag was found. ")
        return false;
      }
