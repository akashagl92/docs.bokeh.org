(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("9915cb00-7094-46d7-94c0-916773ee633d");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '9915cb00-7094-46d7-94c0-916773ee633d' but no matching script tag was found. ")
        return false;
      }
