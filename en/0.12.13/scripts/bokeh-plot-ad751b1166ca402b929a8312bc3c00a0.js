(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("4ef9cfa9-3fc2-4795-856a-593f64c59f0b");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '4ef9cfa9-3fc2-4795-856a-593f64c59f0b' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"69f9532f-db10-4273-b75c-905e785eda11":{"roots":{"references":[{"attributes":{"active":0,"callback":null,"labels":["Option 1","Option 2","Option 3"]},"id":"118455f0-ec8f-42ee-9c5c-d658826a94da","type":"RadioButtonGroup"},{"attributes":{"children":[{"id":"118455f0-ec8f-42ee-9c5c-d658826a94da","type":"RadioButtonGroup"}]},"id":"3443a86a-0d8e-4303-8d51-3c299617733f","type":"WidgetBox"}],"root_ids":["3443a86a-0d8e-4303-8d51-3c299617733f"]},"title":"Bokeh Application","version":"0.12.13"}}';
                  var render_items = [{"docid":"69f9532f-db10-4273-b75c-905e785eda11","elementid":"4ef9cfa9-3fc2-4795-856a-593f64c59f0b","modelid":"3443a86a-0d8e-4303-8d51-3c299617733f"}];
