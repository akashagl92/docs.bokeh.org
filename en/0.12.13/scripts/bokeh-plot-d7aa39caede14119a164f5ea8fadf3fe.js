(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("72061f8e-2904-4f57-b700-d0c62e8638da");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '72061f8e-2904-4f57-b700-d0c62e8638da' but no matching script tag was found. ")
        return false;
      }
