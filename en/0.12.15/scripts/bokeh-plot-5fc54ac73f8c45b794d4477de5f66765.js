(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("7eeacce3-eb33-4eac-8a6e-94af49540a9a");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '7eeacce3-eb33-4eac-8a6e-94af49540a9a' but no matching script tag was found. ")
        return false;
      }
