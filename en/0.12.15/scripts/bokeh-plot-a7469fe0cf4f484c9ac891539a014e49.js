(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("fd61da38-a919-45bf-87d6-5b844df39f77");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid 'fd61da38-a919-45bf-87d6-5b844df39f77' but no matching script tag was found. ")
        return false;
      }
            ...
            var fn = function() {
              Bokeh.safely(function() {
                (function(root) {
                  ...
                  var docs_json = '{"85e5482a-5791-478d-988b-1e50bee5dff3":{"roots":{"references":[{"attributes":{"callback":null,"options":["foo","bar","baz","quux"],"title":"Option:","value":"foo"},"id":"429e9038-4044-4ef9-bfa9-d0a325254d1e","type":"Select"},{"attributes":{"children":[{"id":"429e9038-4044-4ef9-bfa9-d0a325254d1e","type":"Select"}]},"id":"4bc14948-58e3-4ce6-9bf6-c2a40ab4c7ce","type":"WidgetBox"}],"root_ids":["4bc14948-58e3-4ce6-9bf6-c2a40ab4c7ce"]},"title":"Bokeh Application","version":"0.12.15"}}';
                  var render_items = [{"docid":"85e5482a-5791-478d-988b-1e50bee5dff3","elementid":"fd61da38-a919-45bf-87d6-5b844df39f77","modelid":"4bc14948-58e3-4ce6-9bf6-c2a40ab4c7ce"}];
