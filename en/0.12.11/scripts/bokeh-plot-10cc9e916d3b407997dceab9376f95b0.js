(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("307312f6-33ea-40ec-80c1-c9dab4c6481c");
      if (element == null) {
        console.log("Bokeh: ERROR: autoload.js configured with elementid '307312f6-33ea-40ec-80c1-c9dab4c6481c' but no matching script tag was found. ")
        return false;
      }
