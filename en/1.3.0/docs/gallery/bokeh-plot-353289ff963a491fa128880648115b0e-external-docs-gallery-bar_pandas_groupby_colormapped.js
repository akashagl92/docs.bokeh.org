(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("a86b51e9-7923-4ec0-8117-3d95a8fd2309");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'a86b51e9-7923-4ec0-8117-3d95a8fd2309' but no matching script tag was found. ")
        return false;
      }
