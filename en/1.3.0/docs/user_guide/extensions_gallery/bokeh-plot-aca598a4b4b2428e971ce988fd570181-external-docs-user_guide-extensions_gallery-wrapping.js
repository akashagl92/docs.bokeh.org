(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("760b3ca6-f3d4-4d23-b358-717444e65d48");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '760b3ca6-f3d4-4d23-b358-717444e65d48' but no matching script tag was found. ")
        return false;
      }
        ...
        function(Bokeh) {
          ...
          ({
            "custom/main": function(require, module, exports) {
              var models = {
                "Surface3d": require("custom/bk_script_23327.surface3d").Surface3d
              };
              require("base").register_models(models);
              module.exports = models;
            },
            "custom/bk_script_23327.surface3d": function(require, module, exports) {
          "use strict";
